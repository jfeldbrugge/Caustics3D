                ...
                int v0, int v1, int v2, int v3, const double Dp, const int Ni)
{
    ...
    {
        double check1_1 = interpolationCheck1(pp1, g);
        double check1_2 = interpolationCheck1(pp2, g);
        double check2_1 = interpolationCheck2(pp1, g);
        double check2_2 = interpolationCheck2(pp2, g);
        double check3_1 = interpolationCheck3(pp1, g);
        double check3_2 = interpolationCheck3(pp2, g);
        
        double eigen1_1 = interpolationEigen1(pp1, g);
        double eigen1_2 = interpolationEigen1(pp2, g);
        double eigen2_1 = interpolationEigen2(pp1, g);
        double eigen2_2 = interpolationEigen2(pp2, g);
        double eigen3_1 = interpolationEigen3(pp1, g);
        double eigen3_2 = interpolationEigen3(pp2, g);
...
//            const double tres = 1.;
    ...
    push = [&] (int v1, int w1, int v2, int w2, int v3, int w3)
    {
        ...
        double val2_1 = interpolationVal2(p1, g);
        double val2_2 = interpolationVal2(p2, g);
        double val2_3 = interpolationVal2(p3, g);
