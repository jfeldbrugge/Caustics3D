                 ...
                 int v0, int v1, int v2, int v3, int Ni)
{
    ...
    push = [&] (int v1, int w1, int v2, int w2, int v3, int w3)
    {
        ...
        //        Compute A3Bound
        double inner1 = interpolationX(p1, g.p[0], g.inner);
        double inner2 = interpolationX(p2, g.p[0], g.inner);
        double inner3 = interpolationX(p3, g.p[0], g.inner);
                ...
                const int index, const vector2d &eigen, const vector2d &grad, int Ni)
{
    ...
    pushA5 = [&] (const XYZ &p1, const XYZ &p2)
    {
        ...
        double innerDD1 = interpolationX(p1, g.p[0], g.innerDD);
        double innerDD2 = interpolationX(p2, g.p[0], g.innerDD);
    ...
    pushA4A5 = [&] (const XYZ &p1, const XYZ &p2, const XYZ &p3)
    {
        ...
        double innerD1 = interpolationX(p1, g.p[0], g.innerD);
        double innerD2 = interpolationX(p2, g.p[0], g.innerD);
        double innerD3 = interpolationX(p3, g.p[0], g.innerD);
    ...
    pushA3A4A5 = [&] (int v1, int w1, int v2, int w2, int v3, int w3)
    {
        ...
        double eigen1 = interpolationX(p1, g.p[0], g.eigen1);
        double eigen2 = interpolationX(p2, g.p[0], g.eigen1);
        double eigen3 = interpolationX(p3, g.p[0], g.eigen1);
